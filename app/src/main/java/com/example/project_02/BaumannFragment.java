...
public class BaumannFragment extends Fragment {
    ...
    private void init() {
        ...
        //민감성,저항성 문제
        list.add(new checkVO("민감성vs저항성", "1. 얼굴에 붉게 돌출된 병변이 발생한 경험이 있습니까?", "전혀 없다", "거의 없다", "최소한 1개월에 1회 있다", "최소한 1주일에 1회 있다"));
        list.add(new checkVO("민감성vs저항성", "2. 피부 관리용 제품(클렌저,보습제,색조화장품, 및 화장품 등을 포함)을 사용하면 얼굴에 뾰루지가 나거나 발진, 가려움증, 혹은 따끔거리는 증상 등이 나타난 경험이 있습니까?",
                "전혀 없다", "거의 없다", "자주 있다", "항상 있다", "난느 얼굴에 피부 관리용 제품을 바르지 않는다"));
        list.add(new checkVO("민감성vs저항성", "3. 과거에 여드름이나 주사에 대한 진단을 받은 적이 있습니까?", "없다", "친구와 지인이 나에게 이런 증상이 있다고 얘기한다", "진단을 받았다", "심각한 경우에 해당한다",
                "잘 모르겠다"));
        list.add(new checkVO("민감성vs저항성", "4. 14k금이 아닌 장신구를 착용할 경우에 피부 발진이 자주 발생합니까?", "전혀 안 나타난다", "거의 안 나타난다", "자주 나타난다", "항상 나타난다", "잘 모르겠다"));
        list.add(new checkVO("민감성vs저항성", "5. 과거에 아토피 피부염, 습진, 또는 접촉성 피부염(알레르기성 피부 발진)으로 진단을 받은 적이 있습니까?",
                "없다", "친구들이 나에게 이런 질환이 있는 것 같다고 한다", "있다", "있다, 심각한 경우에 해당한다", "잘 모르겠다"));
        list.add(new checkVO("민감성vs저항성", "6. 향로가 포함된 거품 입욕제, 마사지 오일, 혹은 바디 로션 등을 사용하면 피부 발진이 생기거나, 가렵거나 건조한 느낌이 있습니까?",
                "전혀 없다", "거의 없다", "자주 나타난다", "항상 나탄다", "나는 이런 종류의 제품을 사용하지 않는다"));
        list.add(new checkVO("민감성vs저항성", "7. 가족 중에서 아토피 피부염, 습진, 천식, 알레르기로 진단받은 분이 있습니까?", "없다", "가족 중 한 명이 진단 받았다",
                "가족 중 몇 명이 진단 받았다", "가족 중 많은 사람이 피부염, 습진, 천식, 알레르기를 가지고 있다", "잘 모르겠다"));
        list.add(new checkVO("민감성vs저항성", "8. 운동, 스트레스 또는 격한 감정(분노 등), 음주, 맵거나 뜨거운 음식 섭취에 의해 얼굴과 목이 붉어집니까?", "전혀 그런 적이 없다",
                "때때로 그렇다", "자주 그렇다", "항상 그렇다"));
        list.add(new checkVO("민감성vs저항성", "9. 얼굴이나 코에 붉거나 푸른색의 혈관이 얼마나 많이 보입니까(혹은 치룢 전에 얼마나 많이 보였습니까)?", "없다",
                "드물게 보인다(코를 포함한 얼굴 전체에서 1~3개)", "약간 보인다(코를 포함한 얼굴 전체에서 4~6개)", "많이 보인다(코를 포함한 얼굴 전체에서 7개 이상)"));

        //색소성,비색소성 문제
        list.add(new checkVO("색소성vs비색소성", "1. 여드름 혹은 피부 속으로 파고 들어간 모발에 의해 짙은 갈색이나 짙은 점이 생깁니까?", "전혀 생기지 않는다", "때때로 생긴다", "자주 생긴다",
                "항상 생긴다", "여드름이나 피부 속으로 파고 들어간 모발이 전혀 없다"));
        list.add(new checkVO("색소성vs비색소성", "2. 얼굴의 짙은 점은 햇빛에 의해 악화됩니까?", "짙은 점이 전혀 없다", "잘 모르겠다", "약간 나빠진다", "많이 나빠진다", "" +
                "매일 자외선차단제를 얼굴에 바르고 햇빛을 피한다"));
        list.add(new checkVO("색소성vs비색소성", "3. 과거에 얼굴 기미(옅거나 짙은 갈색 혹은 회색 반점)로 진단 받은 적이 있습니까?", "없다", "한 번 있었지만 소실되었다", "있다", "있으며 심각한 경우이다",
                "잘 모르겠다"));
        list.add(new checkVO("색소성vs비색소성", "4. 얼굴, 가슴, 등 혹은 양 팔에 작은 갈색 점(주근깨, 일광 흑자)이있거나 있었던 적이 있습니까?", "없다", "약간 있다(1~5개)",
                "많이 있다(6~15개", "대단히 많다(16개 이상)"));
        list.add(new checkVO("색소성vs비색소성", "5. 며칠동안 계속해서 햇빛에 노출되면 어떤 일이 일어납니까?", "햇빛에 타서 물집이 생겼으나 피부색은 변하지 않는다",
                "피부색이 약간 짙어졌다", "피부색이 많이 짙어졌다", "원래 피부색이 짙어서 더 짙어졌는지 구분이 어렵다", "잘 모르겠다"));
        list.add(new checkVO("색소성vs비색소성", "6. 햇볕에 나가면 주근깨(작은 1~2 mm 크기의 편평한 점)가 생기나요?", "전혀 생기지 않는다", "매년 약간씩 작은 주근깨가 생긴다",
                "자주 주근깨가 생긴다", "피부가 이미 짙어서 주근깨가 있는 지 구분이 어렵다", "햇볕에 전혀 나가지 않는다"));
        list.add(new checkVO("색소성vs비색소성", "7. 부모님 중의 어느 한 분이라도 주근깨가 있나요?(만약 그렇다면,얼마나 많았는지 지적해주세요 두 분 중 아무도 그렇지 않거나 한 분만 해당하면 질문에 답해 주세요 두분이 모두 있으면 주근깨가 가장 많았던 분과 관련된 질문에 답해 주세요",
                "없다", "얼굴에 약간 있었다", "얼굴에 많이 있었다", "얼굴, 가슴, 목, 양쪽 어깨에 많이 있었다", "잘 모르겠다"));

        //주름,탱탱함 문제
        list.add(new checkVO("주름vs탱탱함", "1. 얼굴에 주름이 있나요?", "없다 웃거나 찡그리거나 눈썹을 치켜 올릴 경우에도 없다", "웃거나 찡그리거나 눈썹을 치켜 올릴 때에 있다", "있다 얼굴을 움직이거나 움직임이 없는 안정된 상태에서도 약간 있다",
                "웃거나 찡그리거나 혹은 눈썹을 치켜 올리지 않아도 주름이 있다"));
        list.add(new checkVO("주름vs탱탱함", "2. 어머니의 얼굴 피부는 어떻습니까?", "나이보다 5~10년 젋어 보인다/보였다", "나이대로 보인다/보였다", "나이보다 5년 이상 더 젊어 보인다/보였다", "나이보다 5년 이상 더 늙어 보인다/보였다",
                "모른다 입양되었거나 기억이 안난다"));
        list.add(new checkVO("주름vs탱탱함", "3. 아버지의 얼굴 피부는 어떻습니까?", "나이보다 5~10년 젊어 보인다/보였다", "나이대로 보인다/보였다", "나이보다 5년 이상 더 젋어 보인다/보였다", "나이보다 5년 이상 더 늙어 보인다/보였다",
                "모른다 입양되었거나 기억이 안난다"));
        list.add(new checkVO("주름vs탱탱함", "4. 1년에 2주 이상 계속 피부를 태운 적이 있었습니까?(만약 그랬다면, 몇 년 동안이나 그렇게 했나요? 테니스,낚시,골프,스키 혹은 다른 야외 활동에 의해 피부가 탔을 경우에도 빈도를 세어 주세요",
                "없다", "1~5년", "5~10년", "10년 초과"));
        list.add(new checkVO("주름vs탱탱함", "5. 일상생활을 기준으로, 일상생활 중에서 햇빛에 노출 되는 시간은 하루에 얼마나 됩니까?", "별로 없다(흐리거나 구름이 많은 장소에서 주로 살아왔다)",
                "약간 있다(때떄로 덜 화창한 기후에서 살았지만 규칙적으로 일광이 존재하는 장소에서 살아왔다", "보통이다(꽤 많은 양의 일광이 존재하는 장소에서 살아왔다", "" +
                "많다(열대,남부,혹은 매우 화창한 장소에서 살아왔다"));
        list.add(new checkVO("주름vs탱탱함", "6. 나는 얼마나 나이 들어 보인다고 생각합니까?", "내 나이보다 1~5년 더 젊어 보인다", "내 나이대로 보인다", "내 나이보다 5년 더 늙어 보인다", "내 나이보다 5년 이상 더 늙어보인다"));
        list.add(new checkVO("주름vs탱탱함", "7. 지난 5년 동안에 야외 스포츠나 다른 활동에 의해 피부를 얼마나 자주 태웠습니까?", "전혀 안 태웠다", "1개월에 1회", "1주일에 1회", "매일"));
        list.add(new checkVO("주름vs탱탱함", "8. 담배를 얼마나 많이 피웁니까?(혹은 담배연기에 얼마나 많이 노출되었나요?)", "전혀 아니다", "두 세 갑", "몇 갑~ 여러 갑", "매일 피운다",
                "담배를 피운 적은 전혀 없지만 규칙적으로 담배를 피우는 사람과 함께 지냈거나 그들에 의해 양육되었거나 함께 근무하였다"));
        list.add(new checkVO("주름vs탱탱함", "9. 레니노이드가 포함된 안면 크림(레티놀,레노바", "레틴-A,타조락,디페린,어베이지 등)을 사용했다면 얼마나 오래 혹은 자주 사용하셨습니까?",
                "여러 해", "때때로", "젊었을 때 여드름 때문에 1회", "전혀 없다"));
        list.add(new checkVO("주름vs탱탱함", "10. 과일과 채소를 얼마나 자주 섭취하고 있습니까?", "매 끼니마다", "하루 1회", "때때로", "전혀 안 먹는다"));
        list.add(new checkVO("주름vs탱탱함", "11. 원래의 피부 색깔은(피부를 태우거나 태닝을 하지 않았을 때)?", "짙은 색깔", "중간 색깔", "옅은 색깔", "매우 옅은 색깔"));
